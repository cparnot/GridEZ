...
//New instances are always added to the default persistent store (see GEZFrameworkSettings), but using this method, a server can in addition be attached to a custom context (e.g. for document-based app)
