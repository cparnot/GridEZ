...
//Entity names used in the data model of GridEZ
APPKIT_EXTERN NSString *GEZServerEntityName;
APPKIT_EXTERN NSString *GEZGridEntityName;
APPKIT_EXTERN NSString *GEZJobEntityName;
APPKIT_EXTERN NSString *GEZTaskEntityName;
APPKIT_EXTERN NSString *GEZFileEntityName;
APPKIT_EXTERN NSString *GEZMetaJobEntityName;
APPKIT_EXTERN NSString *GEZProxyEntityName;
